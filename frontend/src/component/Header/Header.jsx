...
function Header() {
  ...
  return (
    <>
      <div className='bg-[url(../.././public/header_img.png)] h-[60vh] relative bg-cover flex items-center bg-center rounded-xl bg-no-repeat'>
        <div className='flex flex-col px-8 text-center sm:text-left w-[100%] gap-2 z-10 relative sm:w-[60%]'>
          ...
          <button className='text-white w-[8rem] border-2 border-orange-700 border-solid bg-transparent rounded-2xl py-2 px-5'>View More</button>
        </div>
