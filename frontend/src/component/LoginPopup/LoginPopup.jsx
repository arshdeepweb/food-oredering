...
function LoginPopup({setShowLogin}) {
  ...
  return (
    <div className='absolute w-[100%] top-0 h-[100%] bg-black opacity-95  overflow-y-hidden grid z-50'>
        <form onSubmit={onSubmitHandler} className='p-8 max-w-[330px, 23vw] border-2 border-solid border-[#ec3131] rounded-md bg-white place-self-center'>
        <div className='flex justify-between'>
          ...
          {
            showSignup?
            <button className='p-2 my-2 cursor-pointer border-2 border-solid border-[#ec3131] bg-[#ec3131] text-white w-[100%] text-lg rounded-md'>Create Account</button>:
            <button className='p-2 my-2 cursor-pointer border-2 border-solid border-[#ec3131] bg-[#ec3131] text-white w-[100%] text-lg rounded-md'>Login</button>
          }
        ...
        <div>
          {
            ...
            <div className='flex'>
              ...
              <p onClick={()=>{setShowSignup(false)}} className='text-[#ec3131] px-2 cursor-pointer'>Login Here</p>
            </div>:
            <div className='flex'>
              <p>Create a New Account?</p>
              <p onClick={()=>{setShowSignup(true)}} className='text-[#ec3131] px-1 cursor-pointer'>Click Here</p>
            </div>
          }
